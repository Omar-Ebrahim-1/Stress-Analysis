...
Figure INS and Figure INS, respectively. The figures for the top and bottom
rosettes for steel specimen are shown in Figure INS and Figure INS,
respectively.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./Images/Alu_top.png}
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{Strain gauge readings for aluminum specimen (top rosette)}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{./Images/Alu_bot.png}
    \captionsetup{justification=raggedright,singlelinecheck=false}
